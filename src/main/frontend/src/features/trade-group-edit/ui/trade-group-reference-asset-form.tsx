...
import type { TradeGroup, TradeGroupReferenceAsset } from '@shared/api/schema'
import { ColorPicker } from '@shared/ui'
import { FormContainer, SwitchElement, TextFieldElement, useForm } from 'react-hook-form-mui'

export type TradeGroupReferenceAssetFormProps = {
...
export const TradeGroupReferenceAssetForm = ({
    tradeGroupReferenceAsset,
    formId,
    onSuccess,
    onError
}: TradeGroupReferenceAssetFormProps) => {
    const formContext = useForm({ values: tradeGroupReferenceAsset })
    ...
    return (
        <FormContainer
            ...
            <Grid container spacing={1}>
                ...
                <Grid size={3}>
                    <TextFieldElement type='number' name='priceOffset' label='Смещение цены' required />
                </Grid>
                <Grid size={2}>
                ...
                <Grid size={2}>
                    <TextFieldElement type='number' name='panelNum' label="Панель" />
                </Grid>
                <Grid size={3}>
