...
export const TIMEFRAMES: TimeFrameConfig[] = [
    ...
    { label: "4h", value: "TIME_FRAME_H4", maxDays: 30, intervalSec: 3 * 60 * 60 },
    { label: "8h", value: "TIME_FRAME_H8", maxDays: 30, intervalSec: 6 * 60 * 60 },
    { label: "D", value: "TIME_FRAME_D", maxDays: 365, intervalSec: 23 * 60 * 60 },
